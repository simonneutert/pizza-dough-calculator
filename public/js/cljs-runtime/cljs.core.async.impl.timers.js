...
var i_17802 = (0);
while(true){
if((i_17802 < arr.length)){
(arr[i_17802] = null);

var G__17803 = (i_17802 + (1));
i_17802 = G__17803;
continue;
} else {
}
...
var i_17816 = (self__.level + (1));
while(true){
if((i_17816 <= (new_level + (1)))){
(update[i_17816] = self__.header);

var G__17817 = (i_17816 + (1));
i_17816 = G__17817;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17818 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17818[i]));
} else {
x__$2.forward.push((((i < links_17818.length))?(links_17818[i]):null));
}

if((i < links_17818.length)){
(links_17818[i] = x__$2);
} else {
links_17818.push(x__$2);
}
...
var i_17821 = (0);
while(true){
if((i_17821 <= self__.level)){
var links_17822 = (update[i_17821]).forward;
if((x__$1 === (((i_17821 < links_17822.length))?(links_17822[i_17821]):null))){
(links_17822[i_17821] = (x__$1.forward[i_17821]));

var G__17824 = (i_17821 + (1));
i_17821 = G__17824;
continue;
} else {
var G__17825 = (i_17821 + (1));
i_17821 = G__17825;
continue;
}
} else {
...
var G__17834 = nx;
var G__17835 = (level__$1 - (1));
x = G__17834;
level__$1 = G__17835;
continue;
} else {
var G__17836 = x;
var G__17837 = (level__$1 - (1));
x = G__17836;
level__$1 = G__17837;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17842 = nx;
var G__17843 = (level__$1 - (1));
x = G__17842;
level__$1 = G__17843;
continue;
} else {
var G__17845 = x;
var G__17846 = (level__$1 - (1));
x = G__17845;
level__$1 = G__17846;
continue;
}

...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15086 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15086(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15089 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15089(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15092 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15092(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15094 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15094(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15095 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15095(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15099 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15099(reader);
}
});
...
var G__15144 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15145 = s.append(c);
c = G__15144;
s = G__15145;
continue;
}

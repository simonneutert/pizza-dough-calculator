...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18186 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18186(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18188 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18188(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18191 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18191(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18205 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18205(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18225 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18225(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18234 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18234(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18179,callback){
var map__18181 = p__18179;
var map__18181__$1 = cljs.core.__destructure_map(map__18181);
var input = map__18181__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18181__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18181__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

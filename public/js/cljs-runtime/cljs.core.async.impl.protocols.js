...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15057 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15057(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15059 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15059(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15066 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15066(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15068 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15068(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15074 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15074(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15076 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15076(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15078 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15078(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15081 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15081(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15083 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15083(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15084 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15084(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15087 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15087(b);
}
});
